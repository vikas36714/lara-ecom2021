                ...
                <table class="table table-sm">
                    ...
                    <tbody>
                        <tr v-for="value in values" :key="value.id">
                            ...
                            <td style="width: 25%" class="text-center">{{ value.price ? value.price : 'N/A'}}</td>
...
<script>
    let url = 'http://localhost/lara-ecom2021/admin/attributes/';
    export default {
