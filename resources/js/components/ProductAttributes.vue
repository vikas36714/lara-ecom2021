...
<script>
    let url = 'http://localhost/lara-ecom2021/admin/products/attributes';
    export default {
        ...
        methods: {
            loadProductAttributes(id) {
                let _this = this;
                axios.post('http://localhost/lara-ecom2021/admin/products/attributes', {
                    id: id
            ...
            loadAttributes() {
                let _this = this;
                axios.get(url+'/load').then (function(response){
