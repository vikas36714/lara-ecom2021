@extends('admin.app')
@section('styles')
    <link rel="stylesheet" type="text/css" href="{{ asset('public/backend/css/dropzone.min.css') }}"/>
@endsection
...
@push('scripts')
    ...
    <script type="text/javascript" src="{{ asset('public/backend/js/plugins/dropzone.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('public/backend/js/plugins/bootstrap-notify.min.js') }}"></script>
