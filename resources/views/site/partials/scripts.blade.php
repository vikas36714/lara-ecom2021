...
<script src="{{ asset('public/frontend/plugins/fancybox/fancybox.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('public/frontend/plugins/owlcarousel/owl.carousel.min.js') }}"></script>
